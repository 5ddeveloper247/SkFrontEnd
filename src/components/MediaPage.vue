    ...
    <div>
      ...
      <div class="media mx-md-5 px-md-5 mt-3 pt-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-5">
          <iframe
            v-show="currentTopVideo === 1"
            class="Uvideo-1"
            src="https://www.youtube.com/embed/tgbNymZ7vqY"
          ></iframe>
          <iframe
            v-show="currentTopVideo === 2"
            class="Uvideo-2"
            src="https://www.youtube.com/embed/3WrZMzqpFTc?si=PIqTmb58BLs8ftEQ"
          ></iframe>
          <iframe
            v-show="currentTopVideo === 3"
            class="Uvideo-3"
            src="https://www.youtube.com/embed/wexzvClUcUk?si=e0btNBYWjsyozHtb"
          ></iframe>
          <a
      ...
      <div class="row justify-content-center mx-md-5 mx-2 px-md-5 mt-3 media-cards">
        <div class="col-md-3">
          <div class="card media-card-1" @click="showTopVideo(1)">
            <img src="../assets/Images/media-gallery-1.jpeg" alt="..." />
            <div class="card-body">
              <p class="card-text text-center px-2">
                Inspiring Start Up Dreams Silicon Village Pakistan - Capital Smart
                City
              </p>
            </div>
      ...
      <div class="media mx-md-5 px-md-5 mt-3">
        <div class="d-flex flex-column align-items-center justify-content-center">
          <iframe
            v-show="currentBottomVideo === 1"
            class="Uvideo-4"
            src="https://www.youtube.com/embed/tgbNymZ7vqY"
          ></iframe>
          <iframe
            v-show="currentBottomVideo === 2"
            class="Uvideo-5"
            src="https://www.youtube.com/embed/3WrZMzqpFTc?si=PIqTmb58BLs8ftEQ"
          ></iframe>
          <iframe
            v-show="currentBottomVideo === 3"
            class="Uvideo-6"
            src="https://www.youtube.com/embed/wexzvClUcUk?si=e0btNBYWjsyozHtb"
          ></iframe>
          <a
      ...
      <div class="row justify-content-center mx-md-5 mx-2 px-md-5 mt-3 media-cards">
        <div class="col-md-3">
          <div class="card media-card-4" @click="showBottomVideo(1)">
            <img src="../assets/Images/media-gallery-1.jpeg" alt="..." />
            <div class="card-body">
              <p class="card-text text-center px-2">
                Inspiring Start Up Dreams Silicon Village Pakistan - Capital Smart
