...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/land', name: 'land', component: LandPage },
    { path: '/societies', name: 'societies', component: SocietiesPage },
    { path: '/media', name: 'media', component: MediaPage },
    { path: '/contact', name: 'contact', component: ContactPage },
    { path: '/dha', name: 'dha', component: DhaDetailPage },
    { path: '/bahria', name: 'bahria', component: BahriaDetailPage },
